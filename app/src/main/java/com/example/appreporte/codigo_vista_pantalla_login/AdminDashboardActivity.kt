...
import com.example.appreporte.codigo_vista_pantalla_docente.GestionAlumnosSalonesActivity
...
import com.example.appreporte.codigo_logica_docente.ClassroomAdapter

import com.example.appreporte.codigo_logica_login.UserAdapter
...
class AdminDashboardActivity : AppCompatActivity() {
    ...
    private fun setupBottomNavigation() {
        val userEmail = intent.getStringExtra("USER_EMAIL") ?: ""
        binding.bottomNavigation.selectedItemId = R.id.nav_gestion
