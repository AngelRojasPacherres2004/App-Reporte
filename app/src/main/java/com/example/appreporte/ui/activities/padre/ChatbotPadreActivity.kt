package com.example.appreporte.ui.activities.padre
...
import com.example.appreporte.ui.adapters.ChatAdapter
import com.example.appreporte.ui.adapters.UIMessage
                            ...
                            .addOnSuccessListener { doc ->
                                ...
                                FirebaseFirestore.getInstance().collection("classrooms").document(classroomId).get()
                                    .addOnSuccessListener { classDoc ->
                                        ...
                                        NavigationUtils.navigateToForoDetalle(
                                            this, 
                                            userEmail, 
                                            userRole, 
                                            studentId, 
