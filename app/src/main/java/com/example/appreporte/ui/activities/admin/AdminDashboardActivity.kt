...
import com.example.appreporte.ui.adapters.UserAdapter
...
class AdminDashboardActivity : AppCompatActivity() {
    ...
    private fun setupAdminProfile() {
        binding.ivAdminProfile.setOnClickListener {
            ...
            NavigationUtils.navigateToPerfil(this, userEmail, "admin", currentSchoolId)
        }
    }
    ...
    private fun setupClickListeners() {
        ...
        binding.btnViewStudents.setOnClickListener {
            val userEmail = intent.getStringExtra(NavigationUtils.USER_EMAIL)
            NavigationUtils.navigateToGestionAlumnos(this, userEmail, "admin", currentSchoolId)
        }

        binding.btnAddStudentDirect.setOnClickListener {
            val userEmail = intent.getStringExtra(NavigationUtils.USER_EMAIL)
            NavigationUtils.navigateToGestionAlumnos(this, userEmail, "admin", currentSchoolId, openAddDialog = true)
        }

        // Nuevo: Contactar Súper Administrador
        binding.btnContactarSoporte?.setOnClickListener {
            val userEmail = intent.getStringExtra(NavigationUtils.USER_EMAIL)
            NavigationUtils.navigateToDirectChat(this, userEmail, "superadmin@reporte.com")
        }
    }
    ...
    private fun setupBottomNavigation() {
        ...
        bottomNav.setOnItemSelectedListener { item ->
            ...
            when (item.itemId) {
                R.id.nav_inicio -> {
                    NavigationUtils.navigateToDashboard(this, userEmail, "admin", currentSchoolId)
                    true
                }
                R.id.nav_gestion -> true
                R.id.nav_foro -> {
                    NavigationUtils.navigateToForo(this, userEmail, "admin", currentSchoolId)
                    true
                }
                R.id.nav_asistente -> {
                    NavigationUtils.navigateToAsistente(this, userEmail, "admin")
                    true
                }
                R.id.nav_perfil -> {
                    NavigationUtils.navigateToPerfil(this, userEmail, "admin", currentSchoolId)
