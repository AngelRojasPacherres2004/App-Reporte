...
import com.example.appreporte.ui.adapters.HijosAdapter
    ...
    private fun setupClickListeners() {
        ...
        binding.btnVerReportes.setOnClickListener {
            if (selectedStudentId.isNotEmpty()) {
                NavigationUtils.navigateToReportes(this, userEmail, userRole, selectedStudentId)
            } else {
                Toast.makeText(this, "Seleccione un hijo primero", Toast.LENGTH_SHORT).show()
            }
        }
                ...
                FirebaseFirestore.getInstance().collection("users")
                    ...
                    .addOnSuccessListener { snapshot ->
                        if (!snapshot.isEmpty) {
                            ...
                            NavigationUtils.navigateToDirectChat(this, userEmail, teacherEmail)
                        } else {
    ...
    private fun setupBottomNavigation() {
        ...
        binding.bottomNavigation.setOnItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.nav_asistente -> {
                    NavigationUtils.navigateToAsistente(this, userEmail, selectedStudentId)
                    true
                }
                R.id.nav_reportes -> {
                    if (selectedStudentId.isNotEmpty()) {
