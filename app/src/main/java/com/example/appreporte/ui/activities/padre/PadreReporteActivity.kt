...
import com.example.appreporte.ui.adapters.GradesAdapter
...
class PadreReporteActivity : AppCompatActivity() {
    ...
    private fun setupBottomNavigation() {
        ...
        binding.bottomNavigation.setOnItemSelectedListener { item ->
            when (item.itemId) {
                R.id.nav_inicio -> {
                    NavigationUtils.navigateToDashboard(this, userEmail, "usuario", null)
                    true
                }
                R.id.nav_foro -> {
                    if (studentId.isNotEmpty()) {
                ...
                R.id.nav_perfil -> {
                    NavigationUtils.navigateToPerfil(this, userEmail, "usuario", null)
                    true
                }
                else -> false
            }
