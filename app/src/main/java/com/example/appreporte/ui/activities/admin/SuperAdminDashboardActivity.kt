...
import com.example.appreporte.ui.adapters.SchoolAdapter
import com.example.appreporte.ui.activities.common.DirectChatActivity
import com.example.appreporte.ui.activities.common.MainActivity
...
class SuperAdminDashboardActivity : AppCompatActivity() {
    ...
    private fun showInboxDialog() {
        val superAdminEmail = intent.getStringExtra(NavigationUtils.USER_EMAIL) ?: auth.currentUser?.email ?: "superadmin@reporte.com"
            ...
            .addOnSuccessListener { snapshot ->
                ...
                AlertDialog.Builder(this)
                    ...
                    .setItems(uniqueSenders.toTypedArray()) { _, which ->
                        NavigationUtils.navigateToDirectChat(this, superAdminEmail, uniqueSenders[which])
                    }
                    .show()
            }
