...
import com.example.appreporte.codigo_vista_pantalla_docente.GestionReportesSalonesActivity
            ...
            when (item.itemId) {
                R.id.nav_inicio -> {
                    when (userRole) {
                        ...
                        "docente" -> {
                            val intent = Intent(this, com.example.appreporte.codigo_vista_pantalla_docente.DocenteDashboardActivity::class.java)
                            intent.putExtra("USER_EMAIL", userEmail)
                            intent.putExtra("USER_ROL", userRole)
                            intent.putExtra("SCHOOL_ID", schoolId)
                            startActivity(intent)
                ...
                R.id.nav_asistente -> {
                    val intent = if (userRole == "usuario") {
                        Intent(this, ChatbotPadreActivity::class.java)
                    } else {
                        Intent(this, AsistenteActivity::class.java)
                    }
                    intent.putExtra("USER_EMAIL", userEmail)
                    intent.putExtra("USER_ROL", userRole)
                    startActivity(intent)
